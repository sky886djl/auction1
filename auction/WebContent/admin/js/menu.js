...
function userManager() {
	 document.getElementById("userManager").innerHTML = '<object type="text/html" data="table.html" width="830px" height="420px" style="margin-left:40px;margin-top:20px"></object>';
}