	...
	<form class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="articletitle" name="articletitle" onblur="checkTitle()">
			</div>
		</div>
		<div class="message">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="abstract" id="articleContent" cols="" rows="" class="textarea"  placeholder="说点什么吧..." datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" maxlength="1000"  onkeyup="contentChange(this)"  onpaste="contentChange(this)" onblur="checkContent()" ></textarea>
...
function article_submit_save(flag){
	if(checkAll()){
		...
		if(flag){
			msg='发布';
			url='../article/add_submit';
		} else {
			msg='保存';
			url='../article/add_save';
		}
